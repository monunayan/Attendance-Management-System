...
public class EmailUtil {
    ...
    // Send OTP Email via Direct Native Java SSL Socket (No external Mail JAR required!)
    public static boolean sendOTPEmail(String recipientEmail, String otp) {
        System.out.println("=================================================");
        System.out.println("[EMAIL SERVICE] Dispatching OTP Email to: " + recipientEmail);
        System.out.println("=================================================");
        ...
        try {
            ...
            // Connect directly to Gmail SMTP SSL Port 465
            ...
            sendCommand(out, Base64.getEncoder().encodeToString(cleanPass.getBytes("UTF-8")) + "\r\n");
            ...
            String mailData = "From: College Attendance System <" + SENDER_EMAIL + ">\r\n"
                    ...
                    + otp
                    + "</div>"
                    + "<p style='color: #666; font-size: 13px;'>Valid for current session. Do not share with anyone.</p>"
