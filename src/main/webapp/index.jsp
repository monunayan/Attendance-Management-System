...
<head>
    ...
    <title>College Attendance Management System - Login</title>
...
<body>
    <div class="container py-5">
        <div class="hero">
            ...
            <p class="mb-0">Secure Login Portal for Students and Faculty</p>
        </div>
            ...
            <div class="col-md-6 col-lg-5">
                <div class="card-modern">
                    <div class="card-header-purple text-center">
                        <i class="fa-solid fa-right-to-bracket fs-1 mb-2"></i>
                        <h3 class="m-0 fw-bold">Login to Portal</h3>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <form action="LoginServlet" method="POST">
                            ...
                            <button type="submit" class="btn-purple"><i class="fa-solid fa-right-to-bracket me-2"></i>Login securely</button>
                        </form>
                        <div class="text-center mt-3" id="biometricLoginSection">
                            <div style="border-top: 1px solid #e9ecef; padding-top: 14px; margin-top: 6px;">
                                <button type="button" onclick="loginWithBiometric()" class="btn btn-outline-success rounded-pill fw-bold px-4 py-2 w-100" style="font-size: 0.95rem; border-width: 2px;">
                                    <i class="fa-solid fa-fingerprint me-2 fs-5"></i>Login with Fingerprint
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer bg-light p-3 text-center">
                        <p class="mb-1 text-muted fs-6">Don't have an account?</p>
                        <div class="d-flex justify-content-center gap-2">
                            <a href="student_register.jsp" class="btn btn-outline-primary btn-sm rounded-pill fw-bold px-3">Student Registration</a>
                            <a href="faculty_register.jsp" class="btn btn-outline-danger btn-sm rounded-pill fw-bold px-3">Faculty Registration</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        // Show fingerprint button only if biometric was registered on this device
        document.addEventListener('DOMContentLoaded', function() {
            const bioCredential = localStorage.getItem('cams_last_bio_credential');
            if (bioCredential) {
