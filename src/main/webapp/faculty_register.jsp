                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="FacultyRegisterServlet" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Stream / Department</label>
                            ...
                            <div class="mb-4 bg-light p-3 rounded-3 border">
                                <label class="form-label d-block mb-2 text-primary"><i class="fa-solid fa-layer-group me-1"></i>Select Assigned Semesters</label>
                                <div class="row g-2">
                                    <% for(int i=1; i<=8; i++) { %>
